...
Una posible mejora seria el trabajar en aumentar la cantidad o calidad de las características o ajustar ciertos parámetros de los métodos de clasificación, y en especifico del SVM, para poder aumentar la especificidad del método, ya que aunque lo optimo es buscar una alta sensibilidad se podría ahorrar tiempo perdido en revisar falsos positivos aumentando la especificidad del SVM, asegurando que una estructura clasificada como dañada pertenezca verdaderamente a esa clase.
